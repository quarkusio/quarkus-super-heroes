...
echo
echo "API key: $AZURE_OPENAI_KEY"
echo "Resource Name: $COGNITIVE_SERVICE"
echo "Deployment Name/Id: $COGNITIVE_DEPLOYMENT"
echo "Image Model Deployment Name/Id: $IMAGE_MODEL_DEPLOYMENT"
echo
echo "As environment variables:"
echo "QUARKUS_LANGCHAIN4J_AZURE_OPENAI_API_KEY=$AZURE_OPENAI_KEY"
echo "QUARKUS_LANGCHAIN4J_AZURE_OPENAI_RESOURCE_NAME=$COGNITIVE_SERVICE"
echo "QUARKUS_LANGCHAIN4J_AZURE_OPENAI_DEPLOYMENT_NAME=$COGNITIVE_DEPLOYMENT"
echo "QUARKUS_LANGCHAIN4J_AZURE_OPENAI_DALLE3_DEPLOYMENT_NAME=$IMAGE_MODEL_DEPLOYMENT"
echo
echo "As JVM parameters:"
echo "-Dquarkus.langchain4j.azure-openai.api-key=$AZURE_OPENAI_KEY"
echo "-Dquarkus.langchain4j.azure-openai.resource-name=$COGNITIVE_SERVICE"
echo "-Dquarkus.langchain4j.azure-openai.deployment-name=$COGNITIVE_DEPLOYMENT"
echo "-Dquarkus.langchain4j.azure-openai.dalle3.deployment-name=$IMAGE_MODEL_DEPLOYMENT"
