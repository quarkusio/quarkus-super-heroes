...
|  ---  |  ---  |  ---  |
| `app.envs.QUARKUS_OTEL_K8S_RESOURCE_CONTAINER_NAME` |   | grpc-locations |
| `app.envs.QUARKUS_OTEL_K8S_RESOURCE_DEPLOYMENT_NAME` |   | grpc-locations |
| `app.image` | The container image to use. | quay.io/quarkus-super-heroes/grpc-locations:java21-latest |
...
| `app.ports.http` | The port number to use for http. | 8089 |
| `app.ports.http1` | The http port to use for the probe. | 8089 |
