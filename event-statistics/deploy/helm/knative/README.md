...
Helm chart for event-statistics
## Configuration
...
|  ---  |  ---  |  ---  |
| `app.envs.QUARKUS_OTEL_K8S_RESOURCE_CONTAINER_NAME` |   | event-statistics |
| `app.envs.QUARKUS_OTEL_K8S_RESOURCE_DEPLOYMENT_NAME` |   | event-statistics |
| `app.image` | The container image to use. | quay.io/quarkus-super-heroes/event-statistics:java25-latest |
...
| `app.ports.http` | The port number to use for http. | 8085 |
| `app.ports.http1` | The http port to use for the probe. | 8085 |
