...
The [Build and push container images](../.github/workflows/build-push-container-images-rhbq-3.20.yml) workflow does pretty much what it sounds like: builds and pushes container images. For JVM images, it builds both `amd64` and `arm64` images. Multi-arch native images are coming soon.
...
Each container image created has 2 tags:
- `native-latest-rhbq-3.20-amd64`
- `native-latest-rhbq-3.20-arm64`
