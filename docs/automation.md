...
The [Build and push container images](../.github/workflows/build-push-container-images-rhbq-3.8.yml) workflow does pretty much what it sounds like: builds and pushes container images. For JVM images, it builds both `amd64` and `arm64` images. Multi-arch native images are coming soon.
...
- `java{{java-version}}-latest-rhbq-3.8-amd64`
- `java{{java-version}}-latest-rhbq-3.8-arm64`
...
Each container image created has 2 tags:
- `native-latest-rhbq-3.8-amd64`
- `native-latest-rhbq-3.8-arm64`
