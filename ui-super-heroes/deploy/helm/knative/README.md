...
Helm chart for ui-super-heroes
## Configuration
...
|  ---  |  ---  |  ---  |
| `app.envs.CALCULATE_API_BASE_URL` |   | true |
| `app.envs.QUARKUS_OTEL_K8S_RESOURCE_CONTAINER_NAME` |   | ui-super-heroes |
| `app.envs.QUARKUS_OTEL_K8S_RESOURCE_DEPLOYMENT_NAME` |   | ui-super-heroes |
| `app.envs.quarkus.microcks.default.http.host` |   |   |
| `app.envs.quarkus.microcks.default.http.port` |   |   |
| `app.image` | The container image to use. | quay.io/quarkus-super-heroes/ui-super-heroes:java25-latest |
...
| `app.ports.http1` | The http port to use for the probe. | 8080 |
