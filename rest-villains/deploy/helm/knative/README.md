...
|  ---  |  ---  |  ---  |
| `app.envs.QUARKUS_OTEL_K8S_RESOURCE_CONTAINER_NAME` |   | rest-villains |
| `app.envs.QUARKUS_OTEL_K8S_RESOURCE_DEPLOYMENT_NAME` |   | rest-villains |
| `app.image` | The container image to use. | quay.io/quarkus-super-heroes/rest-villains:java21-latest |
...
| `app.ports.http` | The port number to use for http. | 8084 |
| `app.ports.http1` | The http port to use for the probe. | 8084 |
