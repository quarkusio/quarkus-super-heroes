...
public @interface AzureOpenAIEndpointValid {
  String message() default "Azure OpenAI configuration is enabled (narration.azure-open-ai.enabled = true) but no endpoint (narration.azure-open-id.endpoint) is specified. Please configure an endpoint.";
