	...
	public void getFoundFight() {
		get("/api/fights/{id}", getAndVerifyAllFights().get(0).id)
			...
			.body(
				...
				"winnerLevel", is(5),
				"winnerPicture", is("https://www.superherodb.com/pictures2/portraits/10/050/10466.jpg"),
				"winnerTeam", is(HEROES_TEAM_NAME),
				"loserName", is("Buuccolo"),
				"loserLevel", is(3),
				"loserPicture", is("https://www.superherodb.com/pictures2/portraits/11/050/15355.jpg"),
	...
	private List<Fight> getAndVerifyAllFights() {
		return get("/api/fights")
			...
			.body(
				...
				"[0].winnerLevel", is(5),
				"[0].winnerPicture", is("https://www.superherodb.com/pictures2/portraits/10/050/10466.jpg"),
				"[0].winnerTeam", is(HEROES_TEAM_NAME),
				"[0].loserName", is("Buuccolo"),
				"[0].loserLevel", is(3),
				"[0].loserPicture", is("https://www.superherodb.com/pictures2/portraits/11/050/15355.jpg"),
				"[0].loserTeam", is(VILLAINS_TEAM_NAME),
				"[1].winnerName", is("Galadriel"),
				"[1].winnerLevel", is(10),
				"[1].winnerPicture", is("https://www.superherodb.com/pictures2/portraits/11/050/11796.jpg"),
				"[1].winnerTeam", is(HEROES_TEAM_NAME),
				"[1].loserName", is("Darth Vader"),
				"[1].loserLevel", is(8),
				"[1].loserPicture", is("https://www.superherodb.com/pictures2/portraits/10/050/10444.jpg"),
				"[1].loserTeam", is(VILLAINS_TEAM_NAME),
				"[2].winnerName", is("Annihilus"),
				"[2].winnerLevel", is(23),
				"[2].winnerPicture", is("https://www.superherodb.com/pictures2/portraits/10/050/1307.jpg"),
				"[2].winnerTeam", is(VILLAINS_TEAM_NAME),
				"[2].loserName", is("Shikamaru"),
				"[2].loserLevel", is(1),
				"[2].loserPicture", is("https://www.superherodb.com/pictures2/portraits/10/050/11742.jpg"),
