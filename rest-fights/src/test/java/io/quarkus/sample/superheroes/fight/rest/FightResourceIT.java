...
class FightResourceIT {
  ...
  private static final FightImage DEFAULT_IMAGE = new FightImage("https://somewhere.com/someimage.png");
  private static final FightImage FALLBACK_IMAGE = new FightImage("https://dummyimage.com/240x320/1e8fff/ffffff&text=Fallback+Image");
