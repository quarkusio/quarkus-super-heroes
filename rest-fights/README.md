...
|-------------------------------|-------------|-----------------|-----------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| `/api/fights`                 | `GET`       | `200`           | [`List<Fight>`](src/main/java/io/quarkus/sample/superheroes/fight/Fight.java)           | No query params: all fights. Optional `page` (zero-based) and `size` (default 20, max 100): paginated fights, newest first. Empty array (`[]`) if none or page beyond data. See [OpenAPI](openapi-schema.yml). |
